    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin@eventplanner.com", "Admin", "User", "Admin123!", "1234567890", "Admin", "admin" },
                    { 2, "john.doe@example.com", "John", "Doe", "Password1!", "0987654321", "User", "john.doe" },
                    { 3, "jane.smith@example.com", "Jane", "Smith", "Password2!", "1122334455", "User", "jane.smith" }
                });
